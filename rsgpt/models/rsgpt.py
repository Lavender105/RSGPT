...
from rsgpt.models.blip2 import Blip2Base, disabled_train
from rsgpt.models.modeling_llama import LlamaForCausalLM


@registry.register_model("rsgpt")
class RSGPT(Blip2Base):
    """
    BLIP2 Vicuna model.
    ...
    Usage:
        ...
        >>> model = load_model("rsgpt", "vicuna7b")
    """
    ...
    def __init__(
        ...
        #     filted_prompts = [raw_prompt for raw_prompt in raw_prompts if "<Img><ImageHere></Img> " in raw_prompt]
        #     self.prompt_list = [p.split('<Img><ImageHere></Img> ')[1] for p in filted_prompts]
        #     print('Load {} training prompts'.format(len(self.prompt_list)))
        #     print('Prompt Example \n{}'.format(random.choice(self.prompt_list)))
        #     self.prompt_list_long = self.prompt_list[:4]
        #     self.prompt_list_short = self.prompt_list[4:]
        # else:
        #     self.prompt_list = []
    ...
    def forward(self, samples):
        ...
        #     if samples['dataset'][0] == 'rsicd':
        #         prompt = random.choice(self.prompt_list_short)
        #     else: # ccsub, dota
        #         prompt = random.choice(self.prompt_list_long)
        ...
        text_output_tokens = self.llm_tokenizer(
            # [t + self.end_sym for t in samples['text_input']],
